...
let menu = (event) => {
  let menuObj = {
    ...
    popular: "https://api.themoviedb.org/3/movie/popular?api_key=YOUR_API_KEY",
    trending:
      "https://api.themoviedb.org/3/trending/all/day?api_key=YOUR_API_KEY",
    nowPlaying:
...
let searchFnc = (event) => {
  if (event.keyCode === 13) {
    ...
    let requestUrl = `https://api.themoviedb.org/3/search/movie?query=${arraySearch}&api_key=YOUR_API_KEY`;
